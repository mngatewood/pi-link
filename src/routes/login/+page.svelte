...
<div class="container">
    ...
    <form  method="post" action="?/login" use:enhance>
        <div class="form-item">
            ...
            <br>
            <input bind:this={email} class:fieldError={form?.error} value={form?.email?? ''} id="email" type="email" name="email" required />
        </div>
        ...
        <div class="form-item flex">
            ...
            <button disabled={disableSubmit} type="submit" id="submit-registration" class="button-submit inline-button">Log In</button>
        </div>
    </form>
</div>
