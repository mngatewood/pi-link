...
<div class="container join-container">
    ...
    <form class="flex flex-col h-full" method="post" 
        ...
        <div class="form-item notepad">
            <input bind:value={code} type="text" id="code" class="h-full mb-0" name="code" placeholder="Enter Code" maxlength="4" on:focus={clearMessages}>
        </div>
        ...
        <div class="form-item flex">
            ...
            <button disabled={disableSubmit} class="button-submit inline-button" type="submit" id="submit-join">Join</button>
        </div>
