...
test.describe('detective journey', () => {
	...
	test('detective can complete a round', async ({ page }, workerInfo) => {
		...
		await page.screenshot({
			path: `./test-results/gameplay-detective-s1.${workerInfo.project.name}.png`
		});
		...
		await page.screenshot({
			path: `./test-results/gameplay-detective-s2.${workerInfo.project.name}.png`
		});
		await expect(page.getByRole('heading', { name: 'Round One' })).toBeVisible();
		...
		await page.screenshot({
			path: `./test-results/gameplay-detective-s3.${workerInfo.project.name}.png`
		});
		await expect(page.getByRole('heading', { name: 'Round One' })).toBeVisible();
		...
		await page.screenshot({
			path: `./test-results/gameplay-detective-s4a.${workerInfo.project.name}.png`
		});
		await expect(page.getByRole('heading', { name: 'Round One' })).toBeVisible();
		...
		await page.screenshot({
			path: `./test-results/gameplay-detective-s4b.${workerInfo.project.name}.png`
		});
		await page.getByRole('button', { name: 'Submit' }).click();

		await page.screenshot({
			path: `./test-results/gameplay-detective-s4c.${workerInfo.project.name}.png`
		});
		await expect(page.getByRole('heading', { name: 'Round One' })).toBeVisible();
		await expect(page.getByRole('heading', { name: 'vote on conspirator' })).toBeVisible();
		await expect(page.getByText('Role: **********')).toBeVisible();
		...
		await page.screenshot({
			path: `./test-results/gameplay-detective-s5.${workerInfo.project.name}.png`
		});
		await expect(page.getByRole('heading', { name: 'Round One' })).toBeVisible();
		...
		await page.screenshot({
			path: `./test-results/gameplay-detective-s6.${workerInfo.project.name}.png`
		});
		await expect(page.getByRole('heading', { name: 'Round One' })).toBeVisible();
