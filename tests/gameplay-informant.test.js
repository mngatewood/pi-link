...
test.describe('informant journey', () => {
	...
	test('informer can complete a round', async ({ page }, workerInfo) => {
		...
		await page.screenshot({
			path: `./test-results/gameplay-informant-s1.${workerInfo.project.name}.png`
		});
		...
		await page.screenshot({
			path: `./test-results/gameplay-informant-s2a.${workerInfo.project.name}.png`
		});
		await expect(page.getByRole('heading', { name: 'Round One' })).toBeVisible();
		...
		await page.screenshot({
			path: `./test-results/gameplay-informant-s2b.${workerInfo.project.name}.png`
		});
		await expect(page.getByRole('heading', { name: 'Round One' })).toBeVisible();
		await expect(page.getByRole('heading', { name: 'submit evidence' })).toBeVisible();
		await expect(page.getByText('Role: Informant')).toBeVisible();
		...
		await page.screenshot({
			path: `./test-results/gameplay-informant-s3a.${workerInfo.project.name}.png`
		});
		await expect(page.getByRole('heading', { name: 'Round One' })).toBeVisible();
		...
		await page.screenshot({
			path: `./test-results/gameplay-informant-s3b.${workerInfo.project.name}.png`
		});
		await expect(page.getByRole('heading', { name: 'Round One' })).toBeVisible();
		await expect(page.getByRole('heading', { name: 'defend evidence' })).toBeVisible();
		await expect(page.getByText('Role: Informant')).toBeVisible();
		...
		await page.getByRole('button', { name: 'Proceed to next stage.' }).click();
		await page.screenshot({
			path: `./test-results/gameplay-informant-s4a.${workerInfo.project.name}.png`
		});
		await expect(page.getByRole('heading', { name: 'Round One' })).toBeVisible();
		...
		await page.screenshot({
			path: `./test-results/gameplay-informant-s4b.${workerInfo.project.name}.png`
		});
		await expect(page.getByRole('heading', { name: 'Round One' })).toBeVisible();
		await expect(page.getByRole('heading', { name: 'vote on conspirator' })).toBeVisible();
		await expect(page.getByText('Role: Informant')).toBeVisible();
		...
		await expect(
			page.getByRole('heading', { name: 'Click the button below to continue.' })
		).toBeVisible();
		await expect(page.getByRole('button', { name: 'Proceed to next stage.' })).toBeVisible();
		await expect(page.getByRole('button', { name: '[+]   Help' })).toBeVisible();
		...
		await page.getByRole('button', { name: 'Proceed to next stage.' }).click();
		await page.screenshot({
			path: `./test-results/gameplay-informant-s5.${workerInfo.project.name}.png`
		});
		await expect(page.getByRole('heading', { name: 'Round One' })).toBeVisible();
		...
		await page.screenshot({
			path: `./test-results/gameplay-informant-s6.${workerInfo.project.name}.png`
		});
		await expect(page.getByRole('heading', { name: 'Round One' })).toBeVisible();
